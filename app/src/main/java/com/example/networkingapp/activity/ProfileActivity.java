...
public class ProfileActivity extends AppCompatActivity implements DialogInterface.OnDismissListener {
        ...
        profileOptionBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //if unknown to person
                    ...
                    //if already friends, can cancel friend request
                    ...
                    //accept friend request if already send friend
    ...
    //called in profileOptionsBtn.setOnClickListener
    @Override
        ...
        call.enqueue(new Callback<User>() {
            ...
            public void onResponse(@NonNull Call<User> call, @NonNull final Response<User> response) {
                ...
                if (response.body() != null) {
                    ...
                    //what the text on top right hand corner box looks like
    ...
    private void performAction(final int i) {
        UserInterface userInterface = ApiClient.getApiClient().create(UserInterface.class);
        //getting call from retrofit and enqueing
        ...
        call.enqueue(new Callback<Integer>() {
            ...
            public void onResponse(Call<Integer> call, Response<Integer> response) {
                ...
                if (response.body() == 1) {
                    if (i == 4) {
                        //changing state to 2 because now is pending friend request
                        current_state = 2;
