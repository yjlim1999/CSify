...
import com.example.networkingapp.adapter.FriendAdapter;
...
public class FriendsFragment extends Fragment {
    ...
    Unbinder unbinder;
    //2 adapters because of 2 different recycler views
    ...
    //get all the stuff needed from database
    ...
    public void onPause() {
        ...
        //so that the requests dont appear anymore
        requests.clear();
        friendRequestAdapter.notifyDataSetChanged();
